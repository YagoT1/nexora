...
- [ ] Wireframes del mostrador validados con el personal de la biblioteca.
- [ ] Muestra de datos para staging disponible (sin datos reales de socios).
- [ ] Dos preguntas abiertas de la institución respondidas: presupuesto de hosting y responsabilidad de mantenimiento post-entrega.
...
**Reglas de negocio cubiertas:** ninguna de dominio. Establece la base para todas las demás.
...
**Reglas de negocio cubiertas:** DA-07 (esquema de clasificación propio, jerárquico, máximo 2 niveles), RN-08 (modalidad Solo sala), RN-09 (modalidad Restringido a autorización), D-02 (separación Libro/Ejemplar), D-07 (ISBN no es identificador único), D-09 (estado de Ejemplar parcialmente derivado).
...
*Documento elaborado a partir de la propuesta de arquitectura v2, el modelo de dominio v2 y el relevamiento consolidado v2. Versión 1 — referencia de construcción para el equipo de desarrollo durante la Fase 1.*
